    ...
    <div class="container">
            ...
            <div class="products-toolbar">
                ...
                <select name="category" class="filter-select" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cat->slug ?? $cat->id); ?>" <?php echo e(request('category')==($cat->slug ?? $cat->id)?'selected':''); ?>><?php echo e($cat->name); ?></option>
        ...
        <?php if(isset($products) && $products->count()): ?>
            ...
            <?php if(method_exists($products,'links') && $products->hasPages()): ?>
                <div class="pagination"><?php echo e($products->withQueryString()->links()); ?></div>
            <?php endif; ?>
        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/drgroupb/public_html/resources/views/products/index.blade.php ENDPATH**/ ?>