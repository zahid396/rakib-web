...
<div class="error-page">
    <div class="container">
        ...
        <div class="error-actions">
            <a href="<?php echo e(route('home')); ?>" class="error-btn error-btn-primary">Back to Home</a>
            <a href="<?php echo e(route('products.index')); ?>" class="error-btn error-btn-secondary">Browse Products</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/drgroupb/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>