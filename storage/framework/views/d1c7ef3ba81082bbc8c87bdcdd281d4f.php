...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - <?php echo e($storeSettings['store_name'] ?? 'Store'); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <span class="sidebar-brand-text"><?php echo e($storeSettings['store_name'] ?? 'Store'); ?></span>
        </div>
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.jobs.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.jobs.*') ? 'active' : ''); ?>">
                &#9679; Jobs
            </a>
            <a href="<?php echo e(route('admin.banners.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.banners.*') ? 'active' : ''); ?>">
                &#9654; Banners
            </a>
            ...
            <a href="<?php echo e(route('admin.payment-settings.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.payment-settings.*') ? 'active' : ''); ?>">
                &#9881; Payment Settings
            </a>
            <a href="<?php echo e(route('admin.social-links.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.social-links.*') ? 'active' : ''); ?>">
                &#9742; Social Links
            </a>
            <a href="<?php echo e(route('admin.store-settings.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.store-settings.*') ? 'active' : ''); ?>">
                &#9881; Store Settings
            </a>
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                &#9776; Categories
            </a>
            <a href="<?php echo e(route('admin.legal-pages.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.legal-pages.*') ? 'active' : ''); ?>">
                &#9998; Legal Pages
            </a>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <span style="font-weight:600; font-size:0.9375rem;"><?php echo e($storeSettings['store_name'] ?? 'Store'); ?> Admin</span>
            </div>
            <div class="topbar-right">
                <div class="topbar-user">
                    <div class="topbar-user-avatar"><?php echo e(substr($authAdmin->name ?? 'A', 0, 1)); ?></div>
                    <span><?php echo e($authAdmin->name ?? 'Admin'); ?></span>
                </div>
...
<?php /**PATH /home/drgroupb/public_html/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>