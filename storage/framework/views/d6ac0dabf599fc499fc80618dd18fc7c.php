...
<head>
    ...
    <title><?php echo e($storeSettings['store_name'] ?? config('app.name')); ?></title>
    <?php if(!empty($storeSettings['store_favicon'])): ?>
    <link rel="icon" type="image/png" href="<?php echo e(asset('storage/store/' . $storeSettings['store_favicon'])); ?>">
    <?php endif; ?>
    ...
    <nav class="navbar">
        <div class="container">
            <a href="<?php echo e(route('home')); ?>" class="nav-brand">
                <?php if(!empty($storeSettings['store_logo'])): ?>
                    <img src="<?php echo e(asset('storage/store/' . $storeSettings['store_logo'])); ?>" alt="<?php echo e($storeSettings['store_name']); ?>">
                <?php endif; ?>
                <?php echo e($storeSettings['store_name'] ?? config('app.name')); ?>
...
<a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">Products</a>
                <a href="<?php echo e(route('jobs.index')); ?>" class="<?php echo e(request()->routeIs('jobs.*') ? 'active' : ''); ?>">Jobs</a>
                <a href="<?php echo e(route('home')); ?>#reviews" class="<?php echo e(request()->query('scroll') === 'reviews' ? 'active' : ''); ?>">Reviews</a>
                <a href="<?php echo e(route('home')); ?>#about" class="<?php echo e(request()->query('scroll') === 'about' ? 'active' : ''); ?>">About</a>
            </div>
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">Products</a>
            <a href="<?php echo e(route('jobs.index')); ?>" class="<?php echo e(request()->routeIs('jobs.*') ? 'active' : ''); ?>">Jobs</a>
            <a href="<?php echo e(route('home')); ?>#reviews">Reviews</a>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-grid">
                <div>
                    <div class="footer-brand">
                        <?php if(!empty($storeSettings['store_logo'])): ?>
                            <img src="<?php echo e(asset('storage/store/' . $storeSettings['store_logo'])); ?>" alt="<?php echo e($storeSettings['store_name']); ?>">
                        <?php endif; ?>
                        <?php echo e($storeSettings['store_name'] ?? ''); ?>

                    </div>
                    <?php if(!empty($storeSettings['about_text'])): ?>
                        <p class="footer-about"><?php echo e(Str::limit($storeSettings['about_text'], 180)); ?></p>
                    <?php endif; ?>
                    <?php if($socialLinks && $socialLinks->count()): ?>
                        <div class="footer-social">
                            <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($link->is_active): ?>
                                    <a href="<?php echo e($link->url); ?>" target="_blank" rel="noopener" title="<?php echo e($link->label); ?>"><?php echo $__env->make('partials.platform-icon', ['platform' => $link->platform, 'size' => 18], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></a>
                                <?php endif; ?>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('jobs.index')); ?>">Job Circulars</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#reviews">Reviews</a></li>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <?php if(!empty($storeSettings['contact_email'])): ?>
                            <li><a href="mailto:<?php echo e($storeSettings['contact_email']); ?>">Email Us</a></li>
                        <?php endif; ?>
                        <?php if(!empty($storeSettings['contact_phone'])): ?>
                            <li><a href="tel:<?php echo e($storeSettings['contact_phone']); ?>">Call Us</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div>
            ...
            <div class="footer-bottom">
                <p><?php echo e($storeSettings['copyright_text'] ?? '© ' . date('Y') . ' ' . ($storeSettings['store_name'] ?? '') . '. All rights reserved.'); ?></p>
                <div class="footer-legal">
                    <a href="<?php echo e(route('privacy-policy')); ?>">Privacy</a>
                    <a href="<?php echo e(route('terms')); ?>">Terms</a>
                    <a href="<?php echo e(route('refund-policy')); ?>">Refund</a>
                </div>
                <p style="margin-top:1.25rem; display:flex; align-items:center; justify-content:center; gap:.5rem; flex-wrap:wrap; color:#5b6b8c;">
                    ...
                    <a href="https://wa.me/8801930119616" target="_blank" rel="noopener" style="display:inline-flex; align-items:center; gap:.4rem;">
                        <?php echo $__env->make('partials.platform-icon', ['platform' => 'whatsapp', 'size' => 15], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="modal-box">
            ...
            <div class="support-channels">
                <?php if($socialLinks && $socialLinks->count()): ?>
                    <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($link->is_active): ?>
                            <a href="<?php echo e($link->url); ?>" target="_blank" rel="noopener" class="support-channel">
                                <div class="ch-icon"><?php echo $__env->make('partials.platform-icon', ['platform' => $link->platform, 'size' => 22], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div>
                                <div>
                                    <div class="ch-info"><?php echo e($link->label); ?></div>
                                    <div class="ch-sub">Chat with us on <?php echo e($link->platform); ?></div>
                                </div>
                            </a>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/drgroupb/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>