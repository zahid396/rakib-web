...
<div class="track-page">
    <div class="container">
        ...
        <div class="track-search">
            <form method="POST" action="<?php echo e(route('order.search')); ?>" class="track-search-form">
                <?php echo csrf_field(); ?>
                <input type="text" name="order_id" placeholder="e.g. ORD-20260908-0001" value="<?php echo e(old('order_id', request('order_id'))); ?>" required spellcheck="false" autocomplete="off" maxlength="40">
        ...
        <div class="track-result">
            ...
            <div class="status-summary <?php echo e($statusLower); ?>">
                <?php if($statusLower === 'delivered'): ?>
                    ✓ Your order has been delivered!
                <?php elseif($statusLower === 'verified' || $statusLower === 'completed'): ?>
                ...
                <?php elseif($statusLower === 'rejected'): ?>
                    ...
                    <?php if(!empty($order->rejection_reason)): ?>
                        <div style="margin-top:.5rem; font-weight:600; font-size:.9rem;">Reason: <?php echo e($order->rejection_reason); ?></div>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div class="order-info-card">
                <div class="order-info-header">
                    <h2>Order Details</h2>
                    <span class="oid">#<?php echo e($order->order_id ?? $order->id); ?></span>
                </div>
                <div class="info-rows">
                    <div class="info-row"><span class="label">Product</span><span class="value"><?php echo e($order->product->title ?? 'N/A'); ?></span></div>
                    <div class="info-row"><span class="label">Amount</span><span class="value" style="color:var(--primary);">৳<?php echo e(number_format($order->amount ?? $order->product->effective_price ?? 0, 2)); ?></span></div>
                    <div class="info-row"><span class="label">Payment Method</span><span class="value"><?php echo e(ucfirst($order->payment_method ?? 'N/A')); ?></span></div>
                    <div class="info-row"><span class="label">Date</span><span class="value"><?php echo e($order->created_at ? $order->created_at->format('d M Y, h:i A') : 'N/A'); ?></span></div>
                    <div class="info-row"><span class="label">Status</span><span class="value"><span class="status-badge" style="background:<?php echo e(in_array($statusLower,['delivered','verified','completed'])?'rgba(22,199,132,.14)':($statusLower==='rejected'?'rgba(246,70,93,.14)':'rgba(245,158,11,.16)')); ?>;color:<?php echo e(in_array($statusLower,['delivered','verified','completed'])?'#16c784':($statusLower==='rejected'?'#f6465d':'#fbbf24')); ?>;"><?php echo e(strtoupper($status)); ?></span></span></div>
                    <?php if($statusLower === 'rejected' && !empty($order->rejection_reason)): ?>
                        <div class="info-row"><span class="label">Rejection Reason</span><span class="value" style="color:#f6465d;"><?php echo e($order->rejection_reason); ?></span></div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="timeline">
                ...
                <div class="timeline-steps">
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $stepStatus = 'pending';
                        ...
                        ?>
                        <div class="timeline-step <?php echo e($stepStatus); ?> <?php echo e($stepStatus==='rejected'?'rejected-step':''); ?>">
                            <div class="step-dot <?php echo e($stepStatus); ?>">
                                ...
                                <?php elseif($stepStatus==='rejected'): ?>
                            ...
                            <?php if($stepStatus==='active'||$stepStatus==='done'||$stepStatus==='rejected'): ?>
                                <div class="step-time"><?php if($step['key'] === 'verifying' && $statusLower === 'rejected' && !empty($order->rejection_reason)): ?><?php echo e($order->rejection_reason); ?><?php else: ?><?php echo e($step['desc']); ?><?php endif; ?></div>
                            <?php endif; ?>
                        </div>
            ...
            <div style="text-align:center;">
                <a href="<?php echo e(route('order.track')); ?>" class="back-link">← Track Another Order</a>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/drgroupb/public_html/resources/views/order/track.blade.php ENDPATH**/ ?>