...
<section class="hero" id="heroCarousel">
        ...
        <div class="hero-slide">
            <div class="hero-bg">
                <?php if(!empty($banner->image)): ?>
                    <img src="<?php echo e(asset('storage/banners/' . $banner->image)); ?>" alt="">
                <?php endif; ?>
            </div>
                ...
                <div class="container">
                    <?php if($bannerVid): ?>
                        <div class="hero-text">
                            ...
                            <?php endif; ?>
                            <?php if(!empty($banner->button_text) && !empty($banner->actionUrl())): ?>
                                <a href="<?php echo e($banner->actionUrl()); ?>" class="hero-cta"><?php echo e($banner->button_text); ?> →</a>
                            <?php endif; ?>
                        </div>
                        <div class="hero-img hero-video" style="max-width:560px;">
                            <div class="video-frame" data-video="<?php echo e($bannerVid); ?>">
                                <img class="video-poster" src="https://i.ytimg.com/vi/<?php echo e($bannerVid); ?>/hqdefault.jpg" alt="<?php echo e($banner->title ?? 'Banner video'); ?>">
                                <button type="button" class="video-playbtn" aria-label="Play video">▶</button>
                            </div>
                        </div>
                    <?php elseif($bannerClick): ?>
                        <a href="<?php echo e($bannerClick); ?>" class="hero-cover-link" <?php echo e($banner->action_type === 'external_url' ? 'target="_blank" rel="noopener"' : ''); ?>>
                            <div class="hero-text">
                                <?php if(!empty($banner->title)): ?>
                                    <h1><?php echo e($banner->title); ?></h1>
                                <?php endif; ?>
                            ...
                            <?php if(!empty($banner->image)): ?>
                            <div class="hero-img">
                                <img src="<?php echo e(asset('storage/banners/' . $banner->image)); ?>" alt="<?php echo e($banner->title); ?>">
                            </div>
                            <?php endif; ?>
                            <?php if(!empty($banner->button_text)): ?>
                                <span class="hero-cta"><?php echo e($banner->button_text); ?> →</span>
                            <?php endif; ?>
                        </a>
                    <?php else: ?>
                        <div class="hero-text">
    ...
    <div class="hero-nav" id="heroNav">
        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="hero-dot <?php echo e($i===0?'active':''); ?>" data-slide="<?php echo e($i); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
<?php endif; ?>
...
<section class="trade-hero" id="homeHero">
    ...
    <div class="container">
        <div>
            <span class="trade-badge"><span class="dot"></span> <?php echo $heroBadge; ?></span>
            <h1><?php echo nl2br(e($heroTitle)); ?> <?php if(!empty($heroHl)): ?><span class="hl"><?php echo e($heroHl); ?></span><?php endif; ?></h1>
            <p><?php echo nl2br(e($heroSub)); ?></p>
            <div class="trade-ctas">
                <a href="<?php echo e($cta1Url); ?>" class="btn-gold"><?php echo e($cta1Text); ?> →</a>
                <a href="<?php echo e($cta2Url); ?>" class="btn-ghost"><?php echo e($cta2Text); ?></a>
            </div>
            <div class="trade-stats">
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($stat['value']) || !empty($stat['label'])): ?>
                        <div class="trade-stat"><b><?php echo e($stat['value']); ?></b><span><?php echo e($stat['label']); ?></span></div>
                    <?php else: ?>
                        <div class="trade-stat"><b><?php echo e($statDefaults[$i]['value']); ?></b><span><?php echo e($statDefaults[$i]['label']); ?></span></div>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        <?php if(!empty($storeSettings['hero_image'])): ?>
        <div class="chart-card chart-card-img">
            <img src="<?php echo e(asset('storage/store/' . $storeSettings['hero_image'])); ?>" alt="<?php echo e($heroBadge); ?>">
        </div>
        <?php else: ?>
...
<div class="ticker" aria-hidden="true">
    <div class="ticker-track">
        ...
        ?>
        <?php $__currentLoopData = array_merge($ticks, $ticks); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span class="ticker-item"><b><?php echo e($t[0]); ?></b><span class="val"><?php echo e($t[1] < 1000 ? number_format($t[1], 2) : number_format($t[1], 0)); ?></span><span class="<?php echo e($t[2] === 'up' ? 'up' : 'down'); ?>"><?php echo e($t[2] === 'up' ? '▲' : '▼'); ?> <?php echo e(number_format(abs($t[3]), 2)); ?>%</span></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
...
<section class="section">
    <div class="container">
        ...
        <div style="text-align:center;margin-top:1.5rem;">
            <a href="<?php echo e(route('products.index')); ?>" class="view-all-link">View All Products →</a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section" style="background:var(--gray-100);">
    <div class="container">
        ...
        <div style="text-align:center;margin-top:1.5rem;">
            <a href="<?php echo e(route('jobs.index')); ?>" class="view-all-link">View All Jobs →</a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section" id="reviews" style="background:var(--gray-100);">
    <div class="container">
        ...
        <div class="review-carousel" id="reviewCarousel">
            ...
            <div class="review-card" style="display:<?php echo e($ri===0?'block':'none'); ?>" data-review="<?php echo e($ri); ?>">
                <div class="review-card-inner">
                    <div class="review-stars"><?php echo e(str_repeat('★', $review->rating ?? 5)); ?><?php echo e(str_repeat('☆', max(0, 5 - ($review->rating ?? 5)))); ?></div>
                    <p class="review-text">"<?php echo e($review->review_text ?? ''); ?>"</p>
                    <div class="review-author"><?php echo e($review->customer_name ?? 'Customer'); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <div class="review-nav" id="reviewNav">
                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="review-dot <?php echo e($i===0?'active':''); ?>" data-idx="<?php echo e($i); ?>"></button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
...
<?php if(!empty($storeSettings['about_text'])): ?>
<section class="section" id="about">
    <div class="container">
        <div class="about-section">
            <h2>About <?php echo e($storeSettings['store_name'] ?? 'Us'); ?></h2>
            <p><?php echo nl2br(e($storeSettings['about_text'])); ?></p>
            <div class="about-contact">
                <?php if(!empty($storeSettings['contact_email'])): ?>
                    <div class="about-contact-item"><strong>Email:</strong> <?php echo e($storeSettings['contact_email']); ?></div>
                <?php endif; ?>
                <?php if(!empty($storeSettings['contact_phone'])): ?>
                    <div class="about-contact-item"><strong>Phone:</strong> <?php echo e($storeSettings['contact_phone']); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('partials.product-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/drgroupb/public_html/resources/views/home.blade.php ENDPATH**/ ?>