...
<head>
    ...
    @elseif(!empty($storeSettings['store_logo']))
    <link rel="icon" type="image/png" href="{{ asset('storage/store/' . $storeSettings['store_logo']) }}">
    @endif
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            @if(!empty($storeSettings['store_logo']))
                <img class="sidebar-brand-logo" src="{{ asset('storage/store/' . $storeSettings['store_logo']) }}" alt="{{ $storeSettings['store_name'] }}">
            @else
