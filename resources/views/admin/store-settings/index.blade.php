            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="about_text" name="about_text" class="form-control @error('about_text') is-invalid @enderror" rows="5" maxlength="180" oninput="updateCharCount(this, 'aboutTextCount')">{{ old('about_text', $settings['about_text']) }}</textarea>
                        <div class="form-text" style="display:flex; justify-content:space-between;">
                            <span>This text also appears in the website footer (truncated on mobile).</span>
                            <span><strong id="aboutTextCount">{{ strlen($settings['about_text'] ?? '') }}</strong>/180</span>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <textarea id="footer_text" name="footer_text" class="form-control @error('footer_text') is-invalid @enderror" rows="3" maxlength="180" oninput="updateCharCount(this, 'footerTextCount')">{{ old('footer_text', $settings['footer_text']) }}</textarea>
                        <div class="form-text" style="display:flex; justify-content:space-between;">
                            <span>Keep it short so it displays nicely on phones.</span>
                            <span><strong id="footerTextCount">{{ strlen($settings['footer_text'] ?? '') }}</strong>/180</span>
                        </div>
...
@push('scripts')
<script>
    function updateCharCount(input, elementId) {
        document.getElementById(elementId).textContent = input.value.length;
    }
