...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .job-detail-body p { color: var(--gray-600); line-height: 1.85; font-size: .95rem; margin-bottom: 1rem; white-space: pre-line; overflow-wrap: break-word; word-break: break-word; }
        ...
        /* ── Utility / Responsive ── */
        .rich-text { white-space: pre-wrap; overflow-wrap: break-word; word-break: break-word; }
        .footer-about { word-break: break-word; }
        @media (max-width: 768px) {
